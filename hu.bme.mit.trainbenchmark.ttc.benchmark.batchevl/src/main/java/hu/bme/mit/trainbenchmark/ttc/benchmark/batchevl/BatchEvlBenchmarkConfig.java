...
public class BatchEvlBenchmarkConfig extends BenchmarkConfig {

	public BatchEvlBenchmarkConfig(final String[] args) throws ParseException {
		super(args);
	}

	public BatchEvlBenchmarkConfig(final int size, final int runs, final String query, final int iterationCount, final ChangeSet changeSet,
