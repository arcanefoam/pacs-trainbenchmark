...
public class BatchEvlSwitchSensor extends AbstractBatchEvlBenchmarkCase {

	protected BatchEvlSwitchSensor() {
	...
	private class Transformation extends AbstractBatchEvlTransformationAction {
