...
public class BatchEvlSwitchSet extends AbstractBatchEvlBenchmarkCase {

	public BatchEvlSwitchSet() {
		super("SwitchSet.evl");
	}
	...
	/**
	 * {@link AbstractBatchEvlTransformationAction} implementation for
	 * {@link BatchEvlSwitchSet} case.
	 * 
	 * @author Jonathan Co
	 *
	 */
	public static class Transformation extends AbstractBatchEvlTransformationAction {
	...
	/**
	 * {@link AbstractBatchEvlMatch} implementation for {@link BatchEvlSwitchSet} case.
	 * 
	 * @author Jonathan Co
	 *
	 */
	public class Match extends AbstractBatchEvlMatch {
