...
public class IncEvlBenchmarkConfig extends BenchmarkConfig {

	public IncEvlBenchmarkConfig(final String[] args) throws ParseException {
		super(args);
	}

	public IncEvlBenchmarkConfig(final int size, final int runs, final String query, final int iterationCount, final ChangeSet changeSet,
