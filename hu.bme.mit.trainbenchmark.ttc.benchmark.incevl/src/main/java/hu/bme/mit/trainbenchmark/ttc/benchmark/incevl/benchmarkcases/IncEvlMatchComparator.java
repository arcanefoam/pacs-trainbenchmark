...
public class IncEvlMatchComparator implements Comparator<Object> {
	
	@Override
	public int compare(final Object o1, final Object o2) {
		final RailwayElement[] m1 = ((AbstractIncEvlMatch) o1).match;
		final RailwayElement[] m2 = ((AbstractIncEvlMatch) o2).match;
